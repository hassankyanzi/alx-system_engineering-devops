...
Upon the release of a new version of sente system with improvements at approximately 00:07 East African time (E.A.T), an outage occurred on an isolated
...
simple Sente WordPress site.

## Debugging Process

Bug debugger Kyanzi Hassan Musisi (KHM... as in my actual initials... made that up on the spot, pretty
good, huh?) encountered the issue upon opening the project and being, well, instructed to
address it, roughly 19:20 EAT. He promptly proceeded to undergo solving the problem.
